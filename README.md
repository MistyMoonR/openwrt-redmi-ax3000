...
| Xiaomi CR8806 | ✔️  | ✔️     | ⚠️ Slow `uplink` | ⚠️ Unstable | ✔️      |
| Xiaomi CR8808 | ✔️  | ✔️     | ⚠️ Slow `uplink` | ⚠️ Unstable | ✔️      |
...
Download [`openwrt-ipq50xx-arm-redmi_ax3000-squashfs-nand-factory.ubi`](https://github.com/hzyitc/openwrt-redmi-ax3000/releases/download/latest/openwrt-ipq50xx-arm-redmi_ax3000-squashfs-nand-factory.ubi) and put it into TFTP root.
...
```bash
cd /tmp
wget https://github.com/hzyitc/openwrt-redmi-ax3000/releases/download/latest/openwrt-ipq50xx-arm-redmi_ax3000-squashfs-nand-factory.ubi
